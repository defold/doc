---
title: Samouczek o grze typu endless runner
brief: W tym samouczku zaczniesz od pustego projektu i zbudujesz kompletną grę typu runner z animowaną postacią, kolizjami fizycznymi, przedmiotami do zbierania i punktacją.
---

# Samouczek o grze typu endless runner

W tym samouczku zaczniemy od pustego projektu i zbudujemy kompletną grę typu runner z animowaną postacią, kolizjami fizycznymi, przedmiotami do zbierania i punktacją.
...
Pomysł na tę grę jest taki, że ma to być prosty endless runner. Oznacza to, że obiektów gry platform nie można umieszczać w kolekcji w edytorze. Zamiast tego musimy tworzyć je dynamicznie:
