...
Gdy to nastąpi, tekst nagłówka ("Level completed!") zaczyna stopniowo się pojawiać, jednocześnie zmniejszając skalę do normalnego rozmiaru (100%). Dzieje się to w `on_message()` poniżej.
