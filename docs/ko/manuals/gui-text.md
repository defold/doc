...
에디터 미리보기는 엔진의 폰트 렌더러를 사용하여 텍스트 셰이핑과 오른쪽에서 왼쪽으로 쓰는 레이아웃을 지원합니다. 필요한 폰트 및 App Manifest 설정은 [텍스트 레이아웃 지원](/manuals/font/#text-layout-support-eg-right-to-left)을 참고하세요.
