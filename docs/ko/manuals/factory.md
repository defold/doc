...
동적 월드에서 동시에 살아 있을 수 있는 가장 많은 게임 오브젝트 수를 기준으로 *Max Instances*를 계획하세요. 다른 컴포넌트 제한이 계산되는 방식은 [컴포넌트 최대 개수 최적화](/manuals/project-settings/#component-max-count-optimizations)를 참고하세요.
