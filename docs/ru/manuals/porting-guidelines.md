...
Прочитайте [руководство по оптимизации](/manuals/optimization), чтобы узнать, как оптимизировать приложение по производительности, размеру, потреблению памяти и батареи.
