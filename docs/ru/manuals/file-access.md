...
Расширения также могут добавлять эти файлы через `ext.properties`. Их пути объединяются с пользовательскими ресурсами проекта как в сборках редактора, так и в архивах Bob. См. раздел [Пользовательские ресурсы расширений](/manuals/extensions/#custom-resources).
