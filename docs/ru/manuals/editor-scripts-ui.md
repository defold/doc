...
В этом руководстве объясняется, как создавать интерактивные диалоги и открывать ресурсы в редакторе с помощью скриптов редактора на Lua. Чтобы начать работу со скриптами редактора, см. [руководство по скриптам редактора](/manuals/editor-scripts). Полный справочник по API редактора находится [здесь](/ref/editor-lua/).
