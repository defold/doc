...
*Sound*
: Звуковой файл проекта в формате _Wave_, _Ogg Vorbis_ или _Ogg Opus_. Defold поддерживает Wave-файлы с 8- и 16-битным PCM. Воспроизведение Ogg Opus необязательно и требует включить **Include Sound Decoder: Opus** в [манифесте приложения](/manuals/app-manifest/#sound); по умолчанию декодер Opus не включён.
