...
Исходники Defold собираются с использованием версии C++ по умолчанию для каждого компилятора. Большая часть исходного кода движка не использует возможности C++ новее C++98, однако в некоторых местах используется C++11. Хотя использовать более новую версию для расширения возможно, это может вызвать проблемы с ABI. Это может привести к невозможности использования расширения совместно с другими расширениями движка или из [портала ассетов](/assets).
