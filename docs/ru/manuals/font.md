...
О стилизации отдельных фрагментов текста и работе со ссылками и встроенными спрайтами см. в [руководстве по форматированной текстовой разметке](/manuals/font-richtext).
