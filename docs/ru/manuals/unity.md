...
Если нужны подробности, прочитайте краткое [руководство по установке](/manuals/install/).
...
Здесь мы покажем редактор Defold с точки зрения того, что пользователь Unity, вероятно, хочет узнать в первую очередь, но мы настоятельно рекомендуем затем прочитать полное [руководство по обзору редактора](/manuals/editor).
...
| [Label](/manuals/label/) | Text / TextMeshPro | Начиная с Defold 1.13.2, компоненты Label и GUI-ноды Text поддерживают встроенную [форматированную текстовую разметку](/manuals/font-richtext/) для цветов, градиентов, обводок и анимированных эффектов. Также доступно отдельное расширение [RichText](https://defold.com/assets/richtext/). |
...
| [Collision Object](/manuals/physics-objects) | Rigidbody + Collider | В Defold physics object и collision shapes объединены в одном компоненте. |
...
Подробнее о Collections читайте в [руководстве по Building Blocks](/manuals/building-blocks/#collections).
...
Подробнее о расширениях в [руководстве по Native Extensions](/manuals/extensions/).
