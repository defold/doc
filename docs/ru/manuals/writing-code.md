...
Чтобы форматировать изменённые открытые файлы при сохранении, включите **Format on save** в <kbd>Preferences ▸ Code</kbd>. По умолчанию этот параметр отключён; для него требуется языковой сервер с поддержкой форматирования документа. См. [настройки кода](/manuals/editor-preferences/#code).
