...
Format on save
: Запускает форматтер языкового сервера для изменённых открытых файлов кода при сохранении. По умолчанию отключён. Языковой сервер должен поддерживать форматирование; о ручном форматировании документа или выделенного фрагмента см. в разделе [Форматирование кода](/manuals/writing-code/#formatting-code).
