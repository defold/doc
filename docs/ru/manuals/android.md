...
При создании пакета Android-приложений в редакторе Defold или с помощью [инструмента командной строки](/manuals/bob), вы можете указать файл keystore (содержащий ваш сертификат и ключ) и пароль keystore, который будет использоваться при подписании вашего приложения. Если вы этого не сделаете, Defold создаст отладочное keystore и будет использовать его при подписании пакета приложений.
...
Правила сохранения классов для расширения должны находиться в его каталоге `manifests/android`, рядом с `build.gradle`. О том, как добавить файл и сохранить Java-классы расширения, см. в разделе [Правила сохранения R8 для расширений Android](/manuals/extensions/#r8-keep-rules-for-android).
