...
Редактор поддерживает подмножество [Language Server Protocol](https://microsoft.github.io/language-server-protocol/): диагностику (предупреждения линтера), автодополнение, информацию при наведении, символы документа в панели Structure, переход к определению, поиск ссылок, переименование символов и форматирование документа или диапазона. Наведите курсор на символ, чтобы увидеть информацию от языкового сервера. Установив курсор на символ, нажмите <kbd>F2</kbd>, чтобы переименовать его, <kbd>F12</kbd>, чтобы перейти к определению, или <kbd>Shift+F12</kbd>, чтобы найти ссылки. Эти действия также доступны в меню <kbd>Edit</kbd>. О команде форматирования и настройке форматирования при сохранении см. в разделе [Форматирование кода](/manuals/writing-code/#formatting-code).

Встроенный языковой сервер Lua содержит аннотации типов Defold для API среды выполнения и скриптов редактора. В файлах `.editor_script` автодополнение и диагностика распознают функции `editor.*`, а также типы их аргументов и возвращаемых значений. См. раздел [Автодополнение кода](/manuals/writing-code/#code-completion).
