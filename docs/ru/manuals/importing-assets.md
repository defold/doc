...
* Модели в формате glTF могут использоваться [компонентом Model](/manuals/model) для отображения 3D-моделей с анимацией. См. [как импортировать и использовать 3D-модели](/manuals/importing-models).
