...
::: sidenote
Идентификаторы хранятся в виде хэшированных значений. Среда выполнения также сохраняет хэш-состояние каждой идентификации коллекции, которое затем используется для последующего преобразования строки с относительным адресом в хешированый абсолютный идентификатор.
:::
