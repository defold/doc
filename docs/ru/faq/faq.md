...
A: Для редактора/инструментов и runtime движка поддерживаются следующие платформы:
  ...
  | Windows            | Vista              | `x86-64`           | Редактор и движок  |
...
A: Одним нажатием можно публиковать игры для PS4™, PS5™, Nintendo Switch, iOS (64-bit), Android (32-bit and 64-bit), HTML5, а также macOS (x86-64 and arm64), Windows (64-bit) и Linux (x86-64 and arm64). Это действительно одна кодовая база для нескольких поддерживаемых платформ.
