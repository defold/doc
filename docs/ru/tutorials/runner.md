...
Чтобы сделать это и корректно обрабатывать столкновения, потребуется немного векторной математики. Подробное объяснение того, как решать kinematic collisions, есть в [документации Physics](/manuals/physics-resolving-collisions/).
:::
