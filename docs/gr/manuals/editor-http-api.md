...
Η ολοκλήρωση της δημιουργίας δεν σημαίνει ότι το παιχνίδι έχει ολοκληρώσει τη φόρτωση στο πρόγραμμα περιήγησης. Περιμένετε να είναι έτοιμοι ο καμβάς και η εφαρμογή πριν στείλετε είσοδο ή ελέγξετε τη λειτουργία του παιχνιδιού. Δείτε τις [Δοκιμές προγράμματος περιήγησης για HTML5](/manuals/automated-testing/#browser-tests-for-html5) για περισσότερες λεπτομέρειες.
