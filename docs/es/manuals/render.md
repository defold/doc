...
Los render targets admiten anti-aliasing con multimuestreo (MSAA). Esto suaviza los bordes de la geometría en una pasada de renderizado fuera de pantalla. El número de muestras del target es independiente de [Display ▸ Samples](/manuals/project-settings/#samples), que controla el anti-aliasing de la ventana.
