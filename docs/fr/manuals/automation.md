...
| [Tests automatisés](/manuals/automated-testing) | Test de la logique du jeu, des messages, des composants (component), des entrées, de la physique et du comportement du moteur, inspection de scènes, retour visuel par exemple au moyen de l'[aperçu de l'éditeur](/manuals/editor-http-api/#rendering-scene-previews), entrées injectées, état en direct de l'application, [exécution de collections de test](/manuals/automated-testing/#tests-in-a-running-collection) |
