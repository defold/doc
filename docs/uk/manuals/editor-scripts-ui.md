...
Цей посібник пояснює, як створювати інтерактивні елементи інтерфейсу користувача (UI) в редакторі за допомогою скриптів редактора, написаних мовою Lua. Щоб почати працювати зі скриптами редактора, перегляньте [посібник зі скриптів редактора](/manuals/editor-scripts). Повний довідник API редактора можна знайти [тут](/ref/stable/editor-lua/). Наразі можна створювати лише інтерактивні діалогові вікна, але в майбутньому ми хочемо розширити підтримку скриптів UI на решту редактора.
