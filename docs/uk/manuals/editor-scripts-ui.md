...
Цей посібник пояснює, як створювати інтерактивні діалогові вікна й відкривати ресурси в редакторі за допомогою скриптів редактора, написаних мовою Lua. Щоб почати працювати зі скриптами редактора, дивіться [посібник зі скриптів редактора](/manuals/editor-scripts). Повний довідник API редактора доступний [тут](/ref/editor-lua/).
