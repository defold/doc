...
* [HTTP API редактора](/manuals/editor-http-api) надає команди редактора, результати збирання, виведення консолі, пошук у довіднику, попередні перегляди, налаштування й маршрути скриптів редактора.
