...
| Метод | Призначення |
| --- | --- |
| [Попередній перегляд редактора](/manuals/editor-http-api/#rendering-scene-previews) | Компонування завантаженого ресурсу, наприклад рівня або GUI, композиція атласу, інспектування карти плиток, статична композиція сцени, правильність рендерингу редактора й шейдерів або створення мініатюр для документації |
