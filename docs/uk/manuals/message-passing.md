...
Передавання повідомлень — це механізм у Defold, який дає ігровим об’єктам (game object) змогу спілкуватися один з одним. Цей посібник передбачає, що ви знайомі з [механізмом адресації](/manuals/addressing) у Defold та [базовими будівельними блоками](/manuals/building-blocks).
