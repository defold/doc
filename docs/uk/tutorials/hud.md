...
У цьому прикладі проєкту, який можна [відкрити з редактора](/manuals/project-setup/) або [завантажити з GitHub](https://github.com/defold/sample-hud), ми демонструємо ефекти для підрахунку очок. Очки з’являються у випадкових місцях на екрані, імітуючи гру, у якій гравець отримує очки в різних позиціях.
