...
默认的 {{ include.component }} 材质具有以下常量，可以使用 [go.set()](/ref/go/#go.set) 或 [go.animate()](/ref/go/#go.animate) 进行更改（详情请参考[材质手册](/manuals/material/#vertex-and-fragment-constants)）。示例：
```lua
