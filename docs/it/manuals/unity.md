...
| [Label](/manuals/label/) | Text / TextMeshPro | Defold dispone di un'[estensione RichText](https://defold.com/assets/richtext/) per la formattazione avanzata (simile a TextMeshPro). |
